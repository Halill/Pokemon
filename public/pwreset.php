<?php
/**
* Diese Seite ist nur über den Link in der Passwort Vergessen Mail erreichbar.
* Hier kann der User ein neues Passwort eingeben.
* Im Fehlerfall wird per Popup eine Fehlermeldung ausgegeben.
* Hier wird die Funktion pwreset() aufgerufen.
*/
      ...
      <div id="reset">
        ...
        <form action="?send=1&amp;userid=<?php echo htmlentities($_GET['userid']); ?>&amp;code=<?php echo htmlentities($_GET['code']); ?>" method="post">
          ...
          <div class="field-wrap">
            <label>Neues Passwort:<span class="req">*</span></label>
            <input type="password" name="passwort"/>
          </div>

          <div class="field-wrap">
            <label>Passwort bestätigen:<span class="req">*</span></label>
